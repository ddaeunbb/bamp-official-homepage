...
export default function FifthSection() {
  return (
    <section className="h-[340px] bg-defaultYellow flex justify-center items-center gap-x-5 max-md:flex-col max-md:h-max max-md:pt-24">
      <div className="hidden flex-col gap-y-1 max-md:flex max-md:items-center text-center">
        ...
        <Link to={PATH.creditBamsaneung}>
          <MoreBtn />
        </Link>
      </div>
      <div className="flex h-full items-end">
        <img className="w-96" src="/home/bamdi.svg" />
      </div>
